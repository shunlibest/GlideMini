...
public final class FactoryPools {
    ...
    /**
     * 返回一个非线程安全的 {@link Pool}，它永远不会从 {@link Poolacquire()} 返回 {@code null}，
     * 并且包含由给定的 {@link Factory} 创建的具有给定最大大小的类型的对象。
     * <p>如果调用 {@link Poolacquire()} 时池为空，则给定的 {@link Factory} 将用于创建新实例。
     */
    @NonNull
